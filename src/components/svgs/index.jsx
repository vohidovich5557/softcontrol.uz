...
export const ChinaFlag = (props) => (
  ...
  >
    ...
    <path
      fill="#FFDE00"
      d="m5 2.5.588 1.809H7.49l-1.54 1.12.588 1.81L5 5.809l-1.539 1.43.587-1.81-1.538-1.12h1.9L5 2.5zM9.8 1.25l-.3.95h-1l.8.6-.3.95.8-.6.8.6-.3-.95.8-.6h-1l-.3-.95zM11.5 3l-.3.95h-1l.8.6-.3.95.8-.6.8.6-.3-.95.8-.6h-1L11.5 3zm.3 2.5-.3.95h-1l.8.6L11 8l.8-.6.8.6-.3-.95.8-.6h-1l-.3-.95zm-2 1.75-.3.95h-1l.8.6-.3.95.8-.6.8.6-.3-.95.8-.6h-1l-.3-.95z"
    />
  </svg>
)
